...
tf.flags.DEFINE_string('checkpoint_dir', 'checkpoints/20181207-1638', 'checkpoints directory path')

tf.flags.DEFINE_string('XtoY_model', 'female2anime_2.pb', 'XtoY model name, default: apple2orange.pb')
tf.flags.DEFINE_string('YtoX_model', 'anime2female_2.pb', 'YtoX model name, default: orange2apple.pb')

tf.flags.DEFINE_integer('image_size', '128', 'image size, default: 256')
tf.flags.DEFINE_integer('ngf', 64,
                        'number of gen filters in first conv layer, default: 64')
tf.flags.DEFINE_string('norm', 'layer',
