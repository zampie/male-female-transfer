...
# tf.flags.DEFINE_string('X_input_dir', 'data/cat2dog/cat',
#                        'X input directory, default: data/celeba2anime/trainA')
# tf.flags.DEFINE_string('Y_input_dir', 'data/cat2dog/dog',
#                        'Y input directory, default: data/celeba2anime/trainB')
#
# tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/cat.tfrecords',
#                        'X output tfrecords file, default: data/tfrecords/celeba.tfrecords')
# tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/dog.tfrecords',
#                        'Y output tfrecords file, default: data/tfrecords/anime.tfrecords')
